...
const App = () => {
  ...
  return (
    <div className="bg-gray-400">
      <div className="w-full md:max-w-[60%] mx-auto shadow p-10 bg-slate-600 border-4">
      ...
      <br />
      <h1 className="text-4xl font-extrabold dark:text-black text-center">Student Record</h1>
      <br/>
      ...
      <form className="space-y-2" onSubmit={submitHandler}>
        ...
        <label className="dark:text-black leading-6 text-sm font-medium">
          Last Name <br />
          <input
            type="text"
            onChange={changeHandler}
